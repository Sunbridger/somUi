...
class Swiper {
    constructor (options) {
        this._default = {
            container: '.som-swiper',
            item: '.som-carousel-item',
            direction: 'vertical',
            activeClass: 'active',
            threshold: 50,
            duration: 300,
        ...
        this.$container = this._options.container.querySelector('.som-swiper');
    ...
    _setOffset () {
        ...
        arrayFrom(me.$items).forEach(function ($item, key) {
            me._offset.push((key - index) * me._distance); //eslint-disable-line
        });
    }
    ...
    _setTransform (offset) {
        ...
        offset = offset || 0;
        arrayFrom(me.$items).forEach(function ($item, key) {
            let distance = me._offset[key] + offset; //eslint-disable-line
    ...
    _bind () {
        ...
        me.$container.addEventListener('touchstart', me.touchstartHandler, { passive: false });
        me.$container.addEventListener('touchmove', me.touchmoveHandler, { passive: false });
        me.$container.addEventListener('touchend', me.touchendHandler, { passive: false });
        me.$container.addEventListener('touchcancel', me.touchendHandler, false);
    ...
    go (index) {
        ...
        // if (me._options.offset) {
        //     if (me._current < (me.realCount - 1)) {
        //         setTimeout(() => {
        //             me._setTransform(me._options.offset);
        //         }, 2000);
        //     }
        //     if (me._current === (me.realCount - 1)) {
        //         setTimeout(() => {
